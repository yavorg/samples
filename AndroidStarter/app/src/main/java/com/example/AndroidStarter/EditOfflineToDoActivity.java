...
public class EditOfflineToDoActivity extends Activity {

	protected static final String ITEM_TEXT_KEY = "com.example.AndroidStarter.item_text";
	protected static final String ITEM_COMPLETE_KEY = "com.example.AndroidStarter.item_complete";

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_edit_offline_to_do);
