...
namespace DotNetRuntimeDataService.Models
{
    ...
    public class DotNetRuntimeDataContext : DbContext
    {
        ...
        public DotNetRuntimeDataContext() : base(connectionStringName)
        {
        } 
        ...
        public DotNetRuntimeDataContext(string schema) : base(connectionStringName)
        {
            Schema = schema;
        }
